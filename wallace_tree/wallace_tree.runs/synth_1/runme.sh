...
HD_PWD='C:/Wallace tree multiplier/wallace_tree/wallace_tree.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace_tree_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallace_tree_test.tcl
