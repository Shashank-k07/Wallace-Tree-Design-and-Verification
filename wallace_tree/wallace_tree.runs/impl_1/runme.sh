...
HD_PWD='C:/Wallace tree multiplier/wallace_tree/wallace_tree.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace_tree_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wallace_tree_test.tcl -notrace
